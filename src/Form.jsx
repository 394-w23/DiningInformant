    ...
    return (
        <div>
            <form id="userSubmittedForm" className="form">
                <label for="diningHall">Select your current dining hall.</label>
                ...
                <label for="userWaitTime">Enter your approximate wait time in minutes.</label>
                <input value={waitTime} onChange={handleWaitTimeChange} type="number" min="0" max="40" id="userWaitTime"/>
